#R code to generate the graph in Figure_segmental_distribution_of_muscles in Jasek et al. 2021 Platynereis desmosomal connectome paper
...
setwd('/Users/gj274/OneDrive\ -\ University\ of\ Exeter/Paper/Muscle/Figures/Figure_Supplement_muscle_cell_numbers')
...
heatmaply(n_cells,Rowv=F, Colv=F,col=c('white','grey20','#1098CD','red'),column_text_angle = 90,fontsize_col = 6)
